#!/usr/bin/env python3
"""
AIchain Controller v4.0 — Deterministic State Machine
...
def load_config(config_path: Path = None) -> dict:
    """Load unified bridge_config.json."""
...
def inject_model(config: dict, primary_id: str, fallback_ids: list[str]) -> dict:
    """Inject model into OpenClaw config. Returns new config or None if no change."""
...
# Validated against OpenClaw gateway_error.log and Node.js gateway output
